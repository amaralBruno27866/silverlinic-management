...
namespace SilverClinic {
    namespace Forms {
        ...
        BeckDepressionInventory::BeckDepressionInventory() 
            ...
            setTimestamps();
            utils::logStructured(utils::LogLevel::INFO, {"FORM","create","BDI", to_string(m_bdi_id), {}}, "Created");
        }
        ...
        BeckDepressionInventory::BeckDepressionInventory(int case_profile_id) 
            : m_bdi_id(getNextBDIId()), m_case_profile_id(case_profile_id), m_type(FORM_TYPE),
              ...
              m_question_16(0), m_question_17(0), m_question_18(0), m_question_19(0), m_question_20(0), m_question_21(0) {
            setTimestamps();
            utils::logStructured(utils::LogLevel::INFO, {"FORM","create","BDI", to_string(m_bdi_id), {}}, "Created for case: "+ to_string(case_profile_id));
        }
        ...
        BeckDepressionInventory::BeckDepressionInventory(int bdi_id, int case_profile_id, 
            ...
            utils::logStructured(utils::LogLevel::INFO, {"FORM","load","BDI", to_string(m_bdi_id), {}}, "Loaded from database");
        }
        ...
        int BeckDepressionInventory::getNextBDIId() {
            return ++bdi_id_counter; // Sequential IDs starting from 1
        }
        ...
        void BeckDepressionInventory::setQuestion1(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q1","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q1");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion2(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q2","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q2");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion3(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q3","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q3");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion4(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q4","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q4");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion5(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q5","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q5");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion6(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q6","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q6");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion7(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q7","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q7");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion8(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q8","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q8");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion9(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q9","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q9");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion10(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q10","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q10");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion11(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q11","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q11");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion12(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q12","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q12");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion13(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q13","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q13");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion14(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q14","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q14");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion15(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q15","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q15");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion16(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q16","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q16");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion17(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q17","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q17");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion18(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q18","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q18");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion19(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q19","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q19");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion20(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q20","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q20");
            }
        }
        ...
        void BeckDepressionInventory::setQuestion21(int value) {
            if (isValidQuestionValue(value)) {
                ...
                utils::logStructured(utils::LogLevel::WARN, {"FORM","invalid_q21","BDI", to_string(m_bdi_id), {}}, "Invalid value for Q21");
            }
        }
        ...
        int BeckDepressionInventory::getNextId() {
            return bdi_id_counter + 1; // Sequential IDs starting from 1
        }
