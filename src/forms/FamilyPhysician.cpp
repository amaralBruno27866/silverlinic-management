...
const string FamilyPhysician::FORM_TYPE = "FPH";
...
istream& operator>>(istream& is, FamilyPhysician& fp) {
    string line;
    // Format: ID|TYPE|CLIENT_ID|NAME|PHONE|EMAIL|ADDRESS_LINE|CITY|STATE|ZIP
    if (getline(is, line)) {
        istringstream iss(line);
        string id_str, type, client_id_str, name, phone, email;
