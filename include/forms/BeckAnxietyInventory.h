...
namespace SilverClinic {
    namespace Forms {
        ...
        private:
            ...
            // Clinical Questions (21 questions - BAI based on bai.html)
        ...
        public:
            ...
            bool hasMinimalAnxiety() const;
            bool hasMildAnxiety() const;
            bool hasModerateAnxiety() const;
            bool hasSevereAnxiety() const;
