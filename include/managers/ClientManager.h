...
namespace SilverClinic {
    ...
    /**
     * @brief Import clients from a CSV file generated by the form
     * Expected headers: firstname, lastname, phone, email, date_of_birth, created_at,
     * optionally: street, city, province, postal_code, address_created_at
